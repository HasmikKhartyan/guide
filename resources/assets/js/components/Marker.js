                    ...
                    <tr>
                        ...
                        <td >
                            ...
                            {this.props.marker.add ? <button onClick={()=>this.props.addMarker(this.props.marker)} className="btn btn-primary">save</button> :
                                <button onClick={()=>this.props.visited(this.props.marker)} className="btn btn-primary">{this.props.marker.pivot.visited ? 'unvisit':'visit'}</button>}
...
class MarkerTable extends Component {
    ...
    render() {
        ...
        this.state.markers.map((marker) => {
            ...
            rows.push(<MarkerRow key={marker.id} marker={marker} navigate={this.props.navigate}
